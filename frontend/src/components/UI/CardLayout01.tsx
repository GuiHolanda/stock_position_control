...
const CardFrame = (props: HTMLAttributes<HTMLElement>) => {
  return (
    <div
      className={`flex flex-col gap-1 md:gap-3 min-w-48 min-h-40 md:min-w-72 md:min-h-56 md:max-w-80 max-h-96 rounded-[32px] p-4 md:p-8 shadow-xl ${props.className}`}
    >
      {props.children}
    </div>
  );
